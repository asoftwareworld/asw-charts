(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@asoftwareworld/charts/line', ['exports', '@angular/common', '@angular/core', '@asoftwareworld/charts/core', '@asoftwareworld/charts/utils', 'highcharts'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.asoftwareworld = global.asoftwareworld || {}, global.asoftwareworld.charts = global.asoftwareworld.charts || {}, global.asoftwareworld.charts.line = {}), global.ng.common, global.ng.core, global.asoftwareworld.charts.core, global.asoftwareworld.charts.utils, global.Highcharts));
    ...
    var Line = /** @class */ (function () {
        function Line(percentPipe, currencyPipe, aswCurrencyPipe) {
        ...
        Line.prototype.ngAfterViewInit = function () {
            this.viewInitialized = true;
            this.initializeChart();
        };
        Line.prototype.initializeChart = function () {
            if (this.config) {
        ...
        Line.prototype.removeChartCredit = function () {
            this.cloneConfiguration.credits = {
                enabled: false
            };
        };
        Line.prototype.setDonutChartTooltip = function () {
            var this$ = this;
        ...
        Line.prototype.donutChartSliceClick = function () {
            var _this = this;
            if (this.isMute) {
                return;
            }
        ...
        Line.prototype.setDonutChartSeriesOptions = function (series) {
            var _this = this;
        ...
        Line.prototype.sortSeriesData = function (data) {
        ...
        Line.prototype.handleNegativeSeriesData = function (data) {
            data.forEach(function (element) {
                element.value = element.y;
                element.y = element.y ? Math.abs(element.y) : 0.001;
            });
        };
        Line.prototype.setDonutChartLegendOption = function (legendWidthPx) {
            var this$ = this;
        ...
        Line.prototype.setFontSize = function () {
        ...
        Line.prototype.setLegendAlignment = function () {
        ...
        Line.prototype.setLegendVerticalAlignment = function () {
            if (this.deviceSize === core.GridOptionsEnum.ExtraSmall) {
        ...
        Line.prototype.setDonutChartLegendWithHeader = function (legendWidthPx, name, percentage, value) {
        ...
        Line.prototype.setDonutChartInnerText = function () {
            var this$ = this;
        ...
        Line.prototype.setInnerTextLabel = function (width) {
            return "\n        <div style=\"width: " + width + "px; opacity: " + (this.isMute ? 0.35 : 1) + "\">\n            <div class=\"row\">\n                <div class=\"col-md-12 text-truncate\">\n                    " + this.label + "\n                </div>\n            </div>\n        </div>\n        ";
        };
        Line.prototype.setInnerTextIcon = function (width) {
            return "\n        <div style=\"width: " + width + "px; opacity: " + (this.isMute ? 0.35 : 1) + "\">\n            <div class=\"row\">\n                <div class=\"col-md-12 text-truncate\">\n                    " + this.icon + "\n                </div>\n            </div>\n        </div>\n        ";
        };
        Line.prototype.setInnerTextValue = function (width) {
            return "\n        <div style=\"width: " + width + "px; opacity: " + (this.isMute ? 0.35 : 1) + "\">\n            <div class=\"row\">\n                <div class=\"col-md-12 text-truncate\">\n                    <strong>" + this.aswCurrencyPipe.transform(this.amount) + "</strong>\n                </div>\n            </div>\n        </div>\n        ";
        };
        Line.prototype.setInnerTextTarget = function (width) {
    ...
    Line.ctorParameters = function () { return [
    ...
    Line.propDecorators = {
        ...
        pieDonutChart: [{ type: core$1.ViewChild, args: ['lineChart', { static: true },] }],
...
//# sourceMappingURL=asoftwareworld-charts-line.umd.js.map
